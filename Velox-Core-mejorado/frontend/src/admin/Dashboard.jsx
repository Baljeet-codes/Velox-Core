...
export default function Dashboard({ admin, onLogout }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg-0)" }}>
      ...
      {/* Stats */}
      {stats && (
        <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "16px", padding: "24px 28px 0" }}>
          {[
            ...
            { label: "Ingresos", value: `$${(stats.ingresos_totales ?? 0).toLocaleString("es-CO")}`, color: "#34d399" },
          ].map((s) => (
